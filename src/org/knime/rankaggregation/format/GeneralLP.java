...
public class GeneralLP extends AbstractGeneralFile {

	public GeneralLP(BufferedDataTable tableSpecInput, Path localPath, URL url, ExecutionContext exec) {
		super(tableSpecInput, localPath, url, exec);
	}

	@Override
	public void generate() throws IOException, CanceledExecutionException {
		DataTableSpec columns = tableSpecInput.getDataTableSpec();
